...
import '../../brands_view/viewmodel/brandsDetails_view_model.dart';
            ...
            child: Consumer<BrandsDetailsViewModel>(
              builder: (BuildContext context, value, Widget child){
                if (value.status == FetchStatus.error) return const Text("Error");
                  ...
                  itemBuilder: (context,index) =>BrandsItemDetailsCard(
                    product:context.read<BrandsDetailsViewModel>().modelList.elementAt(index),
                    press: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>BrandasDetailScreen())),
